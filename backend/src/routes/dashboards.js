...
router.get('/org', authorize('Founder', 'Admin', 'HR'), dashboardController.orgDashboard);
...
router.get('/workload', authorize('Founder', 'Admin', 'Manager', 'Team Lead', 'Employee', 'HR'), dashboardController.workloadDashboard);
